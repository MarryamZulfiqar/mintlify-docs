---
id: core-value-creation
title: "CORE Value Creation"
sidebar_label: "CORE Value Creation"
sidebar_position: 3
description: "CORE is positioned to be the second asset that Bitcoiners care about—not by competing with Bitcoin, but by complementing it."
keywords: ["core", "value", "creation"]
tags: ["tokenomics", "CORE", "token"]
hide_table_of_contents: false
pagination_next: "concepts/liquid-staking/stCore/stcore-overview"
pagination_prev: "concepts/core-token/tokenomics"
---
# CORE Value Creation

CORE is positioned to be the second asset that Bitcoiners care about—not by competing with Bitcoin, but by complementing it. CORE is the native token of the leading Bitcoin-powered smart contract platform, providing utility across Core's expansive ecosystem of decentralized applications. On top of this foundational ecosystem utility, CORE provides additional genuine utility to Bitcoin holders through [Dual Staking](/docs/07-reference/glossary#d) as the required asset for accessing higher Bitcoin staking yields on Core. These ecosystem and yield utilities are underpinned by CORE's tokenomics, which are designed to align long-term incentives across both the Bitcoin and Core ecosystems.
...
Unlike yield farming projects that exist primarily to distribute rewards, CORE serves as the foundational utility token of a high-performance, [EVM-compatible](/docs/07-reference/glossary#e) blockchain and thriving Bitcoin scaling ecosystem. The token's sustainable value stems from both its role in powering this ecosystem and its utility in unlocking enhanced Bitcoin yields.
...
- [CORE Tokenomics](/docs/[tokenomics](/docs/07-reference/glossary#t))
