---
id: core-token-overview
title: "CORE Token Overview"
sidebar_label: "Overview"
sidebar_position: 1
description: "CORE is the native token of the Core blockchain and the exclusive key to unlocking higher Bitcoin staking yields."
keywords: ["core", "token", "overview"]
...
**[Governance](/docs/07-reference/glossary#g):** CORE holders participate in protocol governance decisions and parameter changes.

**[Validator](/docs/07-reference/glossary#v) Security:** Validators must post a CORE token bond as slashable collateral for network participation.
...
- [CORE Value Creation](/docs/core-value-creation)
