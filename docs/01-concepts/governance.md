---
id: governance
title: "Governance on Core"
sidebar_label: "Governance"
sidebar_position: 10
description: "Core's governance system empowers the community to actively participate in decision-making processes that shape the ecosystem's future, from protocol changes to feature implementations."
keywords: ["governance", "on", "core"]
tags: ["governance", "dao"]
hide_table_of_contents: false
pagination_next: "concepts/security/core-codebase-audits"
pagination_prev: "concepts/rev-plus/track-and-receive-rewards"
---
# Governance on Core

Core's governance system empowers CORE token holders to actively participate in the protocol decisions that shape its future, from parameter changes to new feature implementations. [Governance](/docs/07-reference/glossary#g) follows a progressive decentralization approach, gradually expanding community control as the ecosystem matures.
...
- **[Validator](/docs/07-reference/glossary#v) set changes** including the approval of expansions to the validator set
