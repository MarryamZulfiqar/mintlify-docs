---
id: design
title: "Design of Liquid Staking (stCORE)"
sidebar_label: "Design"
sidebar_position: 2
description: "stCORE is designed to enhance the utility of the CORE token and simplify the staking process."
keywords: ["design", "of", "liquid", "staking"]
tags: ["liquid-staking", "stCORE"]
hide_table_of_contents: false
pagination_next: "concepts/liquid-staking/stCore/how-to-liquid-stake-stcore"
pagination_prev: "concepts/liquid-staking/stCore/stcore-overview"
---
# Design of Liquid Staking (stCORE)

[stCORE](/docs/07-reference/glossary#s) is designed to enhance the utility of the CORE token and simplify the staking process. This initiative allows token holders to maximize the potential of their assets with greater flexibility and efficiency.
...
[Validator](/docs/07-reference/glossary#v) distribution works as follows:
