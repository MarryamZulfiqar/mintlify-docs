---
id: stcore-overview
title: "stCORE - Liquid Staked CORE"
sidebar_label: "Overview"
sidebar_position: 1
description: "Liquid Staking with stCORE enables CORE token holders to participate in network security while maintaining token liquidity."
keywords: ["stcore", "-", "liquid", "staked"]
tags: ["liquid-staking", "stCORE"]
hide_table_of_contents: false
pagination_next: "concepts/liquid-staking/stCore/design"
pagination_prev: "concepts/core-token/core-value-creation"
---
# stCORE - Liquid Staked CORE

[stCORE](/docs/07-reference/glossary#s) is Core's liquid staking token: CORE holders deposit CORE to receive stCORE, which accrues staking rewards while remaining freely transferable and usable in DeFi protocols. Unlike traditional staking, stCORE lets holders earn consensus rewards without locking their capital out of the broader ecosystem.

## What is Liquid Staking?

[Liquid Staking](/docs/07-reference/glossary#l) with stCORE enables CORE token holders to participate in network security while maintaining token liquidity. Unlike traditional staking where tokens become locked and unavailable for other uses, stCORE represents staked CORE tokens in a liquid, transferable form. This allows holders to simultaneously earn staking rewards and utilize their position across DeFi applications, effectively preserving capital efficiency while supporting network security.
...
- [Liquid Staking with stCORE (Guide)](/docs/how-to-liquid-stake-stcore)
