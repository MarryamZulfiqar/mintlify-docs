---
id: how-to-liquid-stake-stcore
title: "Liquid Staking with stCORE"
sidebar_label: "How to Liquid Stake (stCORE)"
sidebar_position: 3
description: "Liquid Staking with stCORE enhances CORE token utility while streamlining the staking process."
keywords: ["liquid", "staking", "with", "stcore"]
tags: ["liquid-staking", "stCORE"]
hide_table_of_contents: false
pagination_next: "concepts/rev-plus/rev-plus-overview"
pagination_prev: "concepts/liquid-staking/stCore/design"
---
# Liquid Staking with stCORE

[Liquid Staking](/docs/07-reference/glossary#l) with stCORE enhances CORE token utility while streamlining the staking process. This guide walks through the end-to-end flow for minting stCORE, tracking accrued yield, and redeeming back to CORE on the Core blockchain.

## Introduction

Liquid Staking with [stCORE](/docs/07-reference/glossary#s) enhances CORE token utility while streamlining the staking process. This guide provides a detailed walkthrough for minting and redeeming stCORE, enabling token holders to maximize capital efficiency while participating in network security.
...
- [stCORE Overview](/docs/stcore-overview)
- [Design of Liquid Staking (stCORE)](/docs/design)
- [stCORE FAQs](/docs/liquid-staking-stcore-faqs)
