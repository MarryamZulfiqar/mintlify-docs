---
id: security-model
title: "Security Model of Core"
sidebar_label: "Security Model"
sidebar_position: 8
description: "Core employs a robust security architecture to mitigate potential threats, integrating both technological safeguards and economic incentives within the Satoshi Plus consensus mechanism."
keywords: ["security", "model", "of", "core"]
tags: ["satoshi-plus", "consensus"]
hide_table_of_contents: false
pagination_next: "concepts/core-concepts/core-token-overview"
pagination_prev: "concepts/core-concepts/rewards"
---
# Security Model of Core

Core employs a layered security architecture that combines Bitcoin's proof-of-work, economic stake-based deterrents, and protocol-level slashing to defend against a broad range of attack vectors. This page documents the specific threats [Satoshi Plus](/docs/07-reference/glossary#s) is designed to resist and the mechanisms that address each.
...
- **Mitigation Achieved By:**
  - **Decentralized [Validator](/docs/07-reference/glossary#v) Base:** By requiring validators to be backed by substantial staking and hashing contributions, the system assigns a broad distribution of control, diluting the power any single miner or group might have.
...
- [Validator Slashing & Jailing](/docs/slashing-overview)
- [Validator Election](/docs/satoshi-plus-validator-election)
- [Third-Party Audit Reports](/docs/core-codebase-audits)
