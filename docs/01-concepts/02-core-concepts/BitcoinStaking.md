---
id: self-custodial-bitcoin-staking
title: "Self-Custodial Bitcoin Staking (Timelocking)"
sidebar_label: "Self-Custodial Bitcoin Staking"
sidebar_position: 4
description: "Self-Custodial Bitcoin Staking enables Bitcoin holders to earn CORE token rewards by participating in Core's consensus—without ever giving up custody of their Bitcoin."
keywords: ["self-custodial", "bitcoin", "staking", "(timelocking)"]
tags: ["satoshi-plus", "consensus"]
hide_table_of_contents: false
pagination_next: "concepts/core-concepts/delegated-proof-of-stake"
pagination_prev: "concepts/core-concepts/delegated-proof-of-work"
---
# Self-Custodial Bitcoin Staking (Timelocking)

Self-Custodial [Bitcoin Staking](/docs/07-reference/glossary#b) enables Bitcoin holders to earn CORE token rewards by participating in Core's consensus without ever relinquishing custody of their BTC. It works by leveraging Bitcoin's native CheckLockTimeVerify (CLTV) opcode to timelock Bitcoin directly on the Bitcoin blockchain.

## Overview

Self-Custodial Bitcoin Staking enables Bitcoin holders to earn CORE token rewards by participating in Core's consensus—**without ever giving up custody of their Bitcoin**. Leveraging Bitcoin's native [CheckLockTimeVerify](/docs/07-reference/glossary#c) (CLTV) opcode, this approach transforms idle Bitcoin into a productive asset while preserving its core principles of security and sovereignty.
...
Core's [relayer](/docs/07-reference/glossary#r) network continuously scans the Bitcoin blockchain to:
