---
id: satoshi-plus-overview
title: "Overview of the Core Blockchain"
sidebar_label: "Overview"
sidebar_position: 1
description: "Core is a high-performance, EVM-compatible Layer 1 blockchain, designed to be Bitcoin's complementary and hyper-scalable smart contract platform."
keywords: ["overview", "of", "the", "core"]
tags: ["consensus", "architecture"]
hide_table_of_contents: false
pagination_next: "concepts/core-concepts/architecture"
pagination_prev: "concepts/introduction/quickstart"
---
# Overview of the Core Blockchain

Core is a high-performance, EVM-compatible Layer 1 blockchain designed to be Bitcoin's complementary smart contract platform. Its [Satoshi Plus](/docs/07-reference/glossary#s) consensus uses Bitcoin mining hash power, timelocked BTC, and staked CORE tokens as three independent security pillars to achieve security, decentralization, and scalability simultaneously.

## Introduction

Core is a high-performance, [EVM-compatible](/docs/07-reference/glossary#e) Layer 1 blockchain, designed to be Bitcoin's complementary and hyper-scalable smart contract platform. By leveraging Bitcoin-native CLTV timelocks, Bitcoin mining hash power, and modern smart contract capabilities, Core unlocks Bitcoin as both the prime protector and central asset of a thriving decentralized application ecosystem.

### The First Self-Custodial Bitcoin Staking Mechanism

Satoshi Plus's Self-Custodial [Bitcoin Staking](/docs/07-reference/glossary#b) component is the first live self-custodial Bitcoin staking mechanism, allowing Bitcoin holders to earn trustless yield without introducing new trust assumptions.
...
This innovative consensus mechanism combines Delegated Proof of Work ([DPoW](/docs/07-reference/glossary#d)), Self-Custodial Bitcoin Staking, and Delegated Proof of Stake (DPoS) thereby incorporating Bitcoin miners, Bitcoin stakers, and CORE stakers, respectively, in the election of Core validators. Each of these three legs of Satoshi Plus introduces a new layer of security and incentive alignment.
