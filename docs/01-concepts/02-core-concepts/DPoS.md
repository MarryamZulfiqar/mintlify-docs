...
sidebar_position: 5
description: "Delegated Proof of Stake (DPoS) is the component of Satoshi Plus consensus that enables CORE token holders to participate in network security by voting for validators via the delegation of tokens."
keywords: ["delegated", "proof", "of", "stake"]
tags: ["satoshi-plus", "consensus"]
hide_table_of_contents: false
pagination_next: "concepts/core-concepts/satoshi-plus-validator-election"
pagination_prev: "concepts/core-concepts/self-custodial-bitcoin-staking"
---
# Delegated Proof of Stake (DPoS)

Delegated Proof of Stake (DPoS) is the component of [Satoshi Plus](/docs/07-reference/glossary#s) consensus that enables CORE token holders to participate in network security by delegating tokens to validators. It creates a direct economic relationship between CORE holders and the validators who secure the Core blockchain.

## Overview

Delegated Proof of Stake ([DPoS](/docs/07-reference/glossary#d)) is the component of **Satoshi Plus consensus** that enables CORE token holders to participate in network security by voting for validators via the delegation of tokens.
