---
id: delegated-proof-of-work
title: "Delegated Proof of Work (DPoW)"
sidebar_label: "Delegated Proof of Work"
sidebar_position: 3
description: "Delegated Proof of Work (DPoW) introduces an innovative way to incorporate Bitcoin's miners in the security and validator election process of Satoshi Plus consensus—without requiring any additional computation."
keywords: ["delegated", "proof", "of", "work"]
tags: ["satoshi-plus", "consensus"]
hide_table_of_contents: false
pagination_next: "concepts/core-concepts/self-custodial-bitcoin-staking"
pagination_prev: "concepts/core-concepts/architecture"
---
# Delegated Proof of Work (DPoW)

Delegated Proof of Work ([DPoW](/docs/07-reference/glossary#d)) lets Bitcoin miners contribute hash power to Core's validator election without any extra computation—by embedding Core delegation metadata in Bitcoin coinbase transactions. This gives miners a second block reward stream while extending Bitcoin's proof-of-work security to Core.

## Overview

Delegated Proof of Work (DPoW) introduces an innovative way to incorporate Bitcoin's miners in the security and validator election process of [Satoshi Plus](/docs/07-reference/glossary#s) consensus—without requiring any additional computation.
...
- **Core [Validator](/docs/07-reference/glossary#v) Address**: The validator the miner is supporting
...
- [Bitcoin Hash Power Delegation](/docs/bitcoin-hash-power-delegation)
