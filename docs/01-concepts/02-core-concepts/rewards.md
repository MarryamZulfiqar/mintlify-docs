...
sidebar_position: 7
description: "The Core network's reward system is a foundational component of the Satoshi Plus consensus, aligning incentives across miners, stakers, validators, relayers, and verifiers."
keywords: ["consensus", "rewards"]
tags: ["satoshi-plus", "consensus"]
hide_table_of_contents: false
pagination_next: "staking/dual-staking/dual-staking-overview"
pagination_prev: "concepts/core-concepts/satoshi-plus-validator-election"
---
# Consensus Rewards

Core's reward system distributes newly minted CORE tokens and transaction fees to every participant who contributes to network security—miners, Bitcoin stakers, CORE stakers, validators, relayers, and verifiers. The structure is designed to align long-term incentives across all stakeholder groups within [Satoshi Plus](/docs/07-reference/glossary#s) consensus.
...
1. Mining ([DPoW](/docs/07-reference/glossary#d))
2. Staking (CORE and Bitcoin)
3. [Validator](/docs/07-reference/glossary#v) Operations
...
- **Yield Multipliers:** Each boosted yield level has a specific multiplier (e, f, g, h,..., etc) that is determined by a user's staking data as well as system [Dual Staking](/docs/07-reference/glossary#d) settings. The settings are dynamically set through governance and reward users for pairing CORE and Bitcoin staking.
