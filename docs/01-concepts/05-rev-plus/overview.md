---
id: rev-plus-overview
title: "Core Rev+ Revenue Sharing Model"
sidebar_label: "Overview"
sidebar_position: 1
description: "Rev+ is Core's protocol-level mechanism that enables fee sharing by distributing a portion of transaction gas fees to various stakeholders, including stablecoin issuers, dApp developers, and DAOs."
keywords: ["core", "rev+", "revenue", "sharing"]
tags: ["rev-plus", "revenue"]
hide_table_of_contents: false
pagination_next: "concepts/rev-plus/protocol-design"
pagination_prev: "concepts/liquid-staking/stCore/how-to-liquid-stake-stcore"
---
# Core Rev+ Revenue Sharing Model 

Rev+ is Core's protocol-level gas fee-sharing mechanism that distributes a portion of transaction fees directly to the smart contract developers, stablecoin issuers, and DAOs whose contracts generated that activity. It creates direct economic alignment between protocol usage and the builders who drive it.

## Introduction

Rev+ is Core's protocol-level mechanism that enables fee sharing by distributing a portion of transaction [gas fees](/docs/07-reference/glossary#g) to various stakeholders, including stablecoin issuers, dApp developers, and DAOs. This innovative feature creates new economic models by allowing different stakeholders to receive a share of transaction gas fees, directly aligning incentives with network growth and activity.
...
* **Focus on Product Quality:** Rev+ provides a direct path from user activity to developer revenue, eliminating the need for complex [tokenomics](/docs/07-reference/glossary#t) or speculation. This enables devs to focus on crafting exceptional user experiences.
