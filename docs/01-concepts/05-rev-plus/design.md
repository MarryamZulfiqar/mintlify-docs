---
id: protocol-design
title: "Core Rev+ Protocol System Design"
sidebar_label: "Protocol Design"
sidebar_position: 2
description: "Rev+ is implemented as a protocol-level feature integrated directly into the Core blockchain's transaction processing pipeline."
keywords: ["core", "rev+", "protocol", "system"]
tags: ["rev-plus", "revenue"]
hide_table_of_contents: false
pagination_next: "concepts/rev-plus/rev-plus-compatibility-guide"
pagination_prev: "concepts/rev-plus/rev-plus-overview"
---
# Core Rev+ Protocol System Design

Rev+ is implemented as a protocol-level feature integrated directly into Core's transaction processing pipeline, comprising an on-chain configuration contract and modifications to block reward distribution logic. This page details the technical architecture, fee flow, and smart contract interfaces that power the Rev+ revenue-sharing model.
...
* **Configuration Sync:** Reads the latest configuration from `Configuration.sol`. [Governance](/docs/07-reference/glossary#g) updates are reflected immediately in the next processed transaction.  
...
The Rev+ protocol operates as a decentralized, post-EVM fee distribution layer that transparently allocates a portion of [gas fees](/docs/07-reference/glossary#g) to designated recipients. This mechanism is executed as part of Core’s transaction finalization process without altering the underlying Rev+ enabled contract logic.
