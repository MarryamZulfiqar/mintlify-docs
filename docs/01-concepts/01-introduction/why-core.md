...
sidebar_position: 2
description: "Core is the high-performance, EVM-compatible blockchain that transforms Bitcoin from a static store of value into a dynamic, productive asset usable across a rich decentralized application ecosystem."
keywords: ["why", "core"]
tags: ["introduction", "core"]
hide_table_of_contents: false
pagination_next: "concepts/introduction/quickstart"
pagination_prev: "concepts/introduction/core-101"
---
# Why Core

Core transforms Bitcoin from a static store of value into a productive asset by letting Bitcoin holders and miners contribute to a high-performance [EVM-compatible](/docs/07-reference/glossary#e) blockchain—and earn yield in return. This page explains the bidirectional value that Core creates for both the Bitcoin and DeFi ecosystems.
...
2. **Enhanced Network Security:** Bitcoin holders, Bitcoin miners, and CORE holders all contribute to Core’s security via [Satoshi Plus](/docs/07-reference/glossary#s) consensus
