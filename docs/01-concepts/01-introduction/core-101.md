---
id: core-101
title: "Core 101: The Bitcoin Everything Chain"
sidebar_label: "Core 101"
sidebar_position: 1
description: "Core is a high-performance, EVM-compatible Layer 1 blockchain secured by Bitcoin."
keywords: ["core", "101", "bitcoin"]
tags: ["introduction", "core"]
hide_table_of_contents: false
pagination_next: concepts/introduction/why-core
pagination_prev: null
---
# Core 101: The Bitcoin Everything Chain

Core is a high-performance, EVM-compatible Layer 1 blockchain secured by Bitcoin's mining network and staked assets. It unlocks trustless yield for Bitcoin holders and miners while powering a full-featured smart contract ecosystem through the [Satoshi Plus](/docs/07-reference/glossary#s) consensus mechanism.

## What is Core?

Core is a high-performance, [EVM-compatible](/docs/07-reference/glossary#e) Layer 1 blockchain secured by Bitcoin. It unlocks trustless yield for Bitcoin holders and Bitcoin miners who help in securing the leading Bitcoin scaling ecosystem via Core's Satoshi Plus consensus.

### Satoshi Plus Consensus

Core's unique consensus mechanism brings together three distinct stakeholder groups to secure the network:

- **Self-Custodial [Bitcoin Staking](/docs/07-reference/glossary#b)**: Bitcoin holders timelock their coins in order to vote for Core validators
...
Bitcoin does not generate native yield like Proof of Stake chains. However, Bitcoin does support native timelocks through its [CLTV](/docs/07-reference/glossary#c) OP_CODE, which lets Bitcoin holders lock their coins on the Bitcoin blockchain to make them unspendable during the designated timelock period.
...
Core's consensus rewards pool is made up of fixed block rewards and [gas fees](/docs/07-reference/glossary#g) from network activity.
...
- **Yield Maximizers**: Stake CORE tokens alongside Bitcoin for enhanced [Dual Staking](/docs/07-reference/glossary#d) rewards
