---
id: dual-staking-faqs
title: "Dual Staking FAQs"
sidebar_label: "Dual Staking FAQs"
sidebar_position: 3
description: "To enable higher yields for Bitcoin staking through Dual Staking, users must meet the following requirements:"
keywords: ["dual", "staking", "faqs"]
tags: ["FAQ", "dual-staking"]
hide_table_of_contents: false
pagination_next: "liquid-staking-stcore-faqs"
pagination_prev: "self-custodial-btc-staking-faqs"
---
# Dual Staking FAQs
---
...
To enable higher yields for Bitcoin staking through [Dual Staking](/docs/07-reference/glossary#d), users must meet the following requirements:
...
* Global staking yields fluctuate based on changes in the following variables:  
  ...
  * [Annual reward adjustment](../Learn/core-token/[tokenomics](/docs/07-reference/glossary#t).md)  
* [Validator](/docs/07-reference/glossary#v)-specific staking yields vary based on these additional factors:  
...
Dual Staking is a [self-custodial process](../stake-and-delegate/btc-staking/overview.md), allowing users to maintain complete control over their assets. Throughout the staking process, Bitcoin remains securely in the user’s wallet.  Stakers face no [slashing](/docs/07-reference/glossary#s) risk, external smart contract risk, or counterparty risk. The trust assumptions for staking Bitcoin are the same trust assumptions underlying holding Bitcoin.
