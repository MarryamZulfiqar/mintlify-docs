---
id: core-validator-faqs
title: "Core Validator FAQs"
sidebar_label: "Core Validator FAQs"
sidebar_position: 5
description: "In the Core ecosystem, 'validator' refers to nodes or participants in the blockchain network that are responsible for verifying, validating, and adding new transactions to the blockchain."
keywords: ["core", "validator", "faqs"]
tags: ["FAQ", "validator"]
hide_table_of_contents: false
pagination_next: "core-nodes-faqs"
pagination_prev: "delegator-faqs"
---
# Core Validator FAQs
---
...
- **Total deposit**: the refundable CORE deposit locked up while performing validator services. On testnet, the minimum amount is **50,000 tCORE2**. Whereas, on the mainnet, the minimum amount is **50,000 CORE**.
...
**Software Requirements:** Currently, a Core [Full Node](/docs/07-reference/glossary#f) can only run on macOS X and Linux.
...
On the Core network, validators are required to stake a certain minimum amount of CORE tokens, which are locked up for the duration that a validator node provides its services. On testnet, the minimum amount is **50,000 tCORE2**. Whereas, on the mainnet, the minimum amount is **50,000 CORE**.
...
1. **[Slashing](/docs/07-reference/glossary#s) Risks:** Validators face slashing for actions like double signing or failing to perform their duties, resulting in a loss of a portion of their staked CORE tokens.
...
The [Validator](/docs/07-reference/glossary#v) election process in Satoshi Plus on the Core network involves several key steps, integrating both Proof of Work (PoW) and Proof of Stake (PoS) elements:
