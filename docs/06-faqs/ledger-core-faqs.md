---
id: hardware-wallet-integration-faqs
title: "Hardware Wallet Integration on Core FAQs"
sidebar_label: "Hardware Wallet Integration FAQs"
sidebar_position: 9
description: "Ledger devices automatically generate a new address each time you connect them."
keywords: ["hardware", "wallet", "integration", "on"]
tags: ["FAQ", "ledger-core"]
hide_table_of_contents: false
pagination_next: "glossary"
pagination_prev: "core-scan-api-faqs"
---
...
2.  Copy the [Bitcoin Staking](/docs/07-reference/glossary#b) Transaction hash. Clicking on it will navigate the user to transaction details on the [Mempool.Space Bitcoin Explorer](https://mempool.space/).
...
- [Stake BTC with Ledger (Mainnet)](/docs/staking-btc-with-core)
- [Stake BTC with Ledger (Testnet)](/docs/ledger-btc-staking-testnet)
