...
sidebar_label: "Intro"
sidebar_position: 1
description: "The Core blockchain is a high-performance, EVM-compatible Layer-1 blockchain, designed to be Bitcoin's complementary and hyper-scalable smart contract platform."
keywords: ["the", "core", "blockchain", "-"]
tags: ["overview", "core"]
hide_table_of_contents: false
pagination_next: "core-101"
pagination_prev: null
---
# Core - The Bitcoin Everything Chain

:::info AI-Ready Documentation
Core DAO docs are fully optimised for AI consumption.

| Resource | URL | Description |
|---|---|---|
| **llms.txt** | [/llms.txt](https://docs.coredao.org/llms.txt) | Index of all 108 pages — for AI navigation |
| **llms-full.txt** | [/llms-full.txt](https://docs.coredao.org/llms-full.txt) | Complete docs content (670KB) — for AI bulk ingestion |
| **Raw markdown** | Add `.md` to any page URL | Clean markdown for AI agents to fetch |
| **MCP server** | Coming soon | Query CoreDAO docs directly from Cursor, Claude Code & Copilot |
