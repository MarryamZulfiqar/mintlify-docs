---
id: delegators
title: "Delegations in the Core Ecosystem"
sidebar_label: "Delegators"
sidebar_position: 2
description: "In the context of the Core blockchain, delegation is a fundamental mechanism that allows BTC miners and BTC and CORE token holders to participate actively in the network's security and governance without being validators themselves."
keywords: ["delegations", "core", "ecosystem","btc","hash","CORE"]
tags: ["staking", "delegators"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/btc-staking-overview"
pagination_prev: "staking/staking-overview"
---
...
## Conclusion
Delegation is one of the key fundamentals of the Core ecosystem, enabling it to maintain a secure, decentralized, and efficient blockchain network. By leveraging the strengths of both DPoS and elements of PoW through the innovative [Satoshi Plus](/docs/07-reference/glossary#s) consensus mechanism, Core not only enhances its operational capabilities but also aligns closely with the decentralized ethos of blockchain technology. This model of delegation ensures that all participants, from individual token holders to large-scale miners, have a stake in the network’s success and governance, making Core a robust and dynamic blockchain platform.