---
id: how-to-dual-stake
title: "How to Dual Stake"
sidebar_label: "How to Dual Stake"
sidebar_position: 6
description: "There are several ways to participate in Dual Staking with Bitcoin and CORE, depending on whether you prefer to use an EVM wallet or a hardware wallet like Ledger."
keywords: ["how", "to", "dual", "stake"]
tags: ["dual-staking", "staking"]
hide_table_of_contents: false
pagination_next: "staking/dual-staking/bitcoin-hash-power-delegation"
pagination_prev: "staking/dual-staking/dual-staking-integration-guide"
---
# How to Dual Stake

---

There are several ways to participate in [Dual Staking](/docs/07-reference/glossary#d) with Bitcoin and CORE, depending on your preferred tools and experience level:
...
**Understanding the Differences in [Bitcoin Staking](/docs/07-reference/glossary#b) Addresses**:
...
Under **Delegate to [Validator](/docs/07-reference/glossary#v)**, from the drop-down menu, select an active validator to whom you want to delegate your Bitcoin.
...
- [Dual Staking Integration Guide](/docs/dual-staking-integration-guide)
