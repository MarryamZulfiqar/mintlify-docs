---
id: dual-staking-guide
title: "Dual Staking on Core"
sidebar_label: "Dual Staking Guide"
sidebar_position: 4
description: "This user guide is designed to walk you through the Dual Staking process on Core."
keywords: ["dual", "staking", "on", "core"]
tags: ["dual-staking", "guide"]
hide_table_of_contents: false
pagination_next: "staking/dual-staking/dual-staking-integration-guide"
pagination_prev: "staking/dual-staking/how-it-works"
---
# Dual Staking on Core

This user guide is designed to walk you through the [Dual Staking](/docs/07-reference/glossary#d) process on Core. Core’s Self-Custodial Bitcoin Staking allows users to earn yield in CORE by staking their Bitcoins and delegating them to validators on Core. Dual Staking unlocks higher yield tiers by staking Bitcoin and CORE to further enhance yield generation from Self-Custodial Bitcoin staking. Let's dive into how it works and learn how to start staking today.
...
3. **Understanding the Differences in [Bitcoin Staking](/docs/07-reference/glossary#b) Addresses:**
...
5. Under **Delegate to [Validator](/docs/07-reference/glossary#v)**, from the drop-down menu, select an **_active validator_** to whom you want to delegate your Bitcoin.
