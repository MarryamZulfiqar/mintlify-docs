---
id: dual-staking-overview
title: "Dual Staking"
sidebar_label: "Overview"
sidebar_position: 1
description: "Dual Staking refers to staking both Bitcoin and CORE tokens simultaneously, with higher CORE-to-Bitcoin staking ratios earning access to higher tiers of yield."
keywords: ["dual", "staking"]
tags: ["dual-staking", "staking"]
hide_table_of_contents: false
pagination_next: "staking/dual-staking/tier-adjustment-system"
pagination_prev: "staking/core-staking/using-ledger-hardware-wallet"
---
# Dual Staking

[Dual Staking](/docs/07-reference/glossary#d) lets participants stake both Bitcoin and CORE tokens simultaneously, with the ratio of CORE to BTC determining which yield tier they access—higher CORE-to-BTC ratios unlock progressively better Bitcoin staking yields. It is the primary mechanism through which Core aligns Bitcoin holders with the long-term growth of the CORE ecosystem.
...
Dual Staking requires simultaneous participation in two legs of Core's tripartite [Satoshi Plus](/docs/07-reference/glossary#s) consensus:

**Self-Custodial [Bitcoin Staking](/docs/07-reference/glossary#b) (Timelocking):**

- Timelock Bitcoin using [CLTV](/docs/07-reference/glossary#c) on the Bitcoin blockchain
...
- CORE delegation operates under the same trust assumptions as [DPoS](/docs/07-reference/glossary#d)
