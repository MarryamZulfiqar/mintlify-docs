---
id: using-ledger-hardware-wallet
title: "Using Ledger Hardware Wallets for Staking CORE"
sidebar_label: "Using Ledger Hardware Wallet"
sidebar_position: 2
description: "This user guide walks you through the process of staking CORE to earn staking rewards on the Core blockchain using a Ledger hardware wallet."
keywords: ["staking", "core", "ledger", "hardware", "wallets"]
tags: ["ledger", "CORE"]
hide_table_of_contents: false
pagination_next: "staking/dual-staking/dual-staking-overview"
pagination_prev: "staking/core-staking/using-evm-wallets"
---
# Using Ledger Hardware Wallets for Staking CORE
---

This user guide walks you through the process of staking CORE to earn staking rewards on the Core blockchain using a Ledger hardware wallet. By following the steps below, you can participate in Core’s [Satoshi Plus](/docs/07-reference/glossary#s) consensus mechanism by staking and delegating CORE.
...
3.  Click on "**View on [Core Scan](/docs/07-reference/glossary#c)**" to view details of your CORE staking transaction on the Core Scan block explorer.
