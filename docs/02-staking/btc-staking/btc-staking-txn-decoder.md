---
id: btc-staking-transaction-decoder
title: "BTC Staking Transaction Decoder"
sidebar_label: "BTC Staking Transaction Decoder"
sidebar_position: 7
description: "The BTC Staking Transaction Decoder is a powerful tool available on Core Scan that allows users to verify and validate their Bitcoin staking transactions."
keywords: ["btc", "staking", "transaction", "decoder"]
tags: ["bitcoin", "decoder"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/ledger-guides/mainnet/staking-btc-with-core"
pagination_prev: "staking/btc-staking/redeem-bitcoin-claim-core"
---
...
- **[Validator](/docs/07-reference/glossary#v) Address Verification**: Confirms that the target validator address is valid and active on the Core network
...
Navigate to the [BTC Staking Transaction Decoder](https://scan.coredao.org/btc-stake-txn-decoder) on [Core Scan](/docs/07-reference/glossary#c).
