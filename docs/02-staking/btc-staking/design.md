...
title: "Self-Custodial Bitcoin Staking Design"
sidebar_label: "Transaction Design"
sidebar_position: 2
description: "The methodology for integrating Bitcoin staking centers on Bitcoin's native CLTV timelock OP_CODE."
keywords: ["self-custodial", "bitcoin", "staking", "transaction", "design"]
tags: ["bitcoin", "staking", "BTC"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/btc-staking-how-it-works"
pagination_prev: "staking/btc-staking/btc-staking-overview"
---
...
Self-Custodial [Bitcoin Staking](/docs/07-reference/glossary#b) operations are conducted on two separate blockchains: Bitcoin and Core. The following flowchart illustrates the workflow for Bitcoin holders to earn staking rewards through Core’s Self-Custodial Bitcoin Staking. 
...
- **`[Satoshi Plus](/docs/07-reference/glossary#s) Identifier`:** (**SAT+**) 4 bytes
- **`Version`:** (**0x01**) 1 byte
- **`Chain ID`:** (1114 for Core Testnet2 and 1116 for Core Mainnet) 2 bytes
- **`Delegator`:** The Core address to receive rewards, 20 bytes
- **`[Validator](/docs/07-reference/glossary#v)`:** The Core validator address to stake to, 20 bytes
- **`Fee`:** Fee for [relayer](/docs/07-reference/glossary#r), 1 byte, range [0,255], measured in CORE
...
- [Bitcoin Staking Transaction Decoder](/docs/btc-staking-transaction-decoder)
