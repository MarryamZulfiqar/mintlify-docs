---
id: redeeming-timelock-expired-btc
title: "Using Ledger Hardware Wallets to Redeem BTC Staked on Core"
sidebar_label: "Redeeming Timelock Expired BTC"
sidebar_position: 2
description: "This user guide will walk you through the step-by-step process of redeeming your staked Bitcoin (BTC) on the Core blockchain using a Ledger hardware wallet."
keywords: ["using", "ledger", "hardware", "wallets"]
tags: ["ledger", "BTC", "mainnet"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/ledger-guides/mainnet/redelegating-staked-btc"
pagination_prev: "staking/btc-staking/ledger-guides/mainnet/staking-btc-with-core"
---
