---
id: ledger-btc-staking-testnet
title: "Using Ledger Hardware Wallets for BTC Staking on Core"
sidebar_label: "Staking BTC with Core"
sidebar_position: 1
description: "This user guide walks you through the process of staking BTC to earn CORE rewards on the Core blockchain using a Ledger hardware wallet."
keywords: ["using", "ledger", "hardware", "wallets"]
tags: ["ledger", "BTC", "testnet"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/ledger-guides/testnet/redeeming-staked-btc"
pagination_prev: "staking/btc-staking/ledger-guides/mainnet/redelegating-staked-btc"
---
# Using Ledger Hardware Wallets for BTC Staking on Core

This user guide walks you through the process of staking BTC to earn CORE rewards on the Core blockchain using a Ledger hardware wallet. By following the steps below, you can participate in Core’s Self-Custodial [Bitcoin Staking](/docs/07-reference/glossary#b) while maintaining complete control of your assets.
