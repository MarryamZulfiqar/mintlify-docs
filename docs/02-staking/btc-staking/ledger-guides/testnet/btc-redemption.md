---
id: redeeming-staked-btc
title: "Using Ledger Hardware Wallets to Redeem BTC Staked on Core"
sidebar_label: "Redeeming Staked BTC"
sidebar_position: 2
description: "This user guide will walk you through the step-by-step process of redeeming your staked Bitcoin (BTC) on the Core Testnet using a Ledger hardware wallet."
keywords: ["using", "ledger", "hardware", "wallets"]
tags: ["ledger", "BTC", "testnet"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/ledger-guides/testnet/redelegating-timelock-expired-btc"
pagination_prev: "staking/btc-staking/ledger-guides/testnet/ledger-btc-staking-testnet"
---
