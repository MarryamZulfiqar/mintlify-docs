---
id: redelegating-timelock-expired-btc
title: "Using Ledger Hardware Wallets to Redelegate Staked BTC on Core"
sidebar_label: "Redelegating Timelock Expired BTC"
sidebar_position: 3
description: "This user guide will walk you through the step-by-step process of redelegating staked expired timelocked Bitcoin (BTC) to a new Core validator on Core Testnet using a Ledger hardware wallet, reinitiating a new BTC staking transaction."
keywords: ["using", "ledger", "hardware", "wallets"]
tags: ["ledger", "BTC", "testnet"]
hide_table_of_contents: false
pagination_next: "staking/core-staking/using-evm-wallets"
pagination_prev: "staking/btc-staking/ledger-guides/testnet/redeeming-staked-btc"
---
...
1.  On the displayed "**Restake BTC**" modal, cross-check the **BTC amount to redelegate**, the **[Bitcoin Staking](/docs/07-reference/glossary#b) Address**, and the **Reward Address on Core Testnet**. To redelegate expired timelocked BTC, users **_must_** connect to the same Bitcoin address as the one initiating the BTC staking transaction.
