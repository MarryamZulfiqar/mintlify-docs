---
id: btc-staking-overview
title: "Self-Custodial Bitcoin Staking"
sidebar_label: "Overview"
sidebar_position: 1
description: "Bitcoin Staking (or Bitcoin Timelocking) enables Bitcoin holders to participate in Core's consensus by timelocking their Bitcoin using its native CheckLockTimeVerify (CLTV) function, without transferring custody or exposing their assets to smart."
keywords: ["self-custodial", "bitcoin", "staking"]
tags: ["bitcoin", "staking", "BTC"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/transaction-design"
pagination_prev: "staking/delegators"
---
# Self-Custodial Bitcoin Staking
[Bitcoin Staking](/docs/07-reference/glossary#b) (or Bitcoin Timelocking) enables Bitcoin holders to participate in Core's consensus by timelocking their Bitcoin using its native CheckLockTimeVerify (CLTV) function, without transferring custody or exposing their assets to smart contract risk.
...
Bitcoin's native protocol includes a [CLTV](/docs/07-reference/glossary#c) function that allows users to make Bitcoin unspendable for a specified period. Core leverages this mechanism to enable Bitcoin holders to participate in consensus while maintaining complete control of their assets.
...
3. **[Validator](/docs/07-reference/glossary#v) Support:** The amount of Bitcoin timelocked in support of a validator influences their position in Core's validator election, impacting their chances of being selected to produce blocks.

4. **[Relayer](/docs/07-reference/glossary#r) Monitoring:** Core's relayer network monitors the Bitcoin blockchain for timelock transactions that include valid consensus metadata.
...
#### **Conclusion**
Bitcoin Staking enables Bitcoin holders to earn yield by contributing to Core's security while maintaining complete custody of their assets. As an integral component of [Satoshi Plus](/docs/07-reference/glossary#s) consensus, it works in concert with DPoW and DPoS to create a robust, multi-layered security framework. This mechanism aligns incentives between Bitcoin holders and the Core network, transforming Bitcoin from a static store of value into a productive asset without requiring it to leave its native blockchain.

## Related

- [How Bitcoin Staking Works](/docs/btc-staking-how-it-works)
- [Bitcoin Staking Design](/docs/transaction-design)
- [Dual Staking Overview](/docs/dual-staking-overview)
- [Self-Custodial Bitcoin Staking (Concept)](/docs/self-custodial-bitcoin-staking)
