---
id: staking-bitcoin-with-core
title: "Self-Custodial Bitcoin Staking"
sidebar_label: "Staking Bitcoin with Core"
sidebar_position: 4
description: "This user guide is designed to walk you through staking your Bitcoin on the Core blockchain to earn CORE token rewards."
keywords: ["self-custodial", "bitcoin", "staking"]
tags: ["bitcoin", "staking", "BTC"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/redeem-bitcoin-claim-core"
pagination_prev: "staking/btc-staking/btc-staking-how-it-works"
---
...
2. **Stake Bitcoin with Time-Lock:** You stake your Bitcoin by sending a transaction on the Bitcoin network with a time-lock parameter, and your Bitcoin remains locked until the specified period ends. Ensure you follow the requirements for a transaction to be valid and eligible; refer [here](../btc-staking/design.md) for more details.
   ...
   2. Include the Core [Validator](/docs/07-reference/glossary#v) Address to delegate your assets.
