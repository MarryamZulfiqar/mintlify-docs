---
id: btc-staking-how-it-works
title: "How Self-Custodial Bitcoin Staking Works {#how-self-custodial-bitcoin-staking-works}"
sidebar_label: "How It Works"
sidebar_position: 3
description: "CheckLockTimeVerify (CLTV) is a Bitcoin-native function that locks transaction outputs until a specified time or block height."
keywords: ["how", "self-custodial", "bitcoin", "staking"]
tags: ["bitcoin", "staking", "BTC"]
hide_table_of_contents: false
pagination_next: "staking/btc-staking/staking-bitcoin-with-core"
pagination_prev: "staking/btc-staking/transaction-design"
---
...
1. **Create timelock transaction** with [CLTV](/docs/07-reference/glossary#c) on Bitcoin blockchain
...
- [Validator](/docs/07-reference/glossary#v) misbehavior cannot affect your Bitcoin principal
