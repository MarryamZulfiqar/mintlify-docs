...
**Dual Staking eligibility.** Self-custodial ZEC staking qualifies for the Dual Staking yield boost when combined with Z token staking. See [Dual Staking](./dual-staking.md).
