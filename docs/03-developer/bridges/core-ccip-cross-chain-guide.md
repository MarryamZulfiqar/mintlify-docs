---
id: chainlink-ccip-guide
title: "Chainlink CCIP Cross-Chain Token Deployment on Core"
sidebar_label: "Chainlink CCIP Guide"
sidebar_position: 3
description: "This guide walks you through deploying cross-chain tokens using **Chainlink CCIP** on the **Core** (Testnet or Mainnet)."
keywords: ["chainlink", "ccip", "cross-chain", "token"]
tags: ["CCIP", "cross-chain"]
hide_table_of_contents: false
pagination_next: "developer/bridges/thirdweb-universal-bridge"
pagination_prev: "developer/bridges/core-bridge-resources"
---
