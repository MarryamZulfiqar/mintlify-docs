---
id: bridging-tokens-using-layerzero
title: "Bridging Tokens to Core With LayerZero (OFT V2)"
sidebar_label: "Bridging Tokens Using LayerZero"
sidebar_position: 1
description: "![Core LayerZero OFT](https://github.com/user-attachments/assets/ac7382c0-6825-4fb8-91c2-5e022a2eca66)"
keywords: ["bridging", "tokens", "to", "core"]
tags: ["bridge", "layerzero"]
hide_table_of_contents: false
pagination_next: "developer/bridges/core-bridge-resources"
pagination_prev: "developer/indexing/core-subgraph-tutorial"
---
...
This documentation walks you through the process of setting up cross-chain token transfers using LayerZero's OFT V2 protocol. The main focus is on enabling ERC-20 token transfers between Core testnet/mainnet and other [EVM-compatible](/docs/07-reference/glossary#e) networks such as Base Sepolia and Optimism. By following this guide, you will learn to:
...
- [Chainlink CCIP Cross-Chain Guide](/docs/chainlink-ccip-guide)
- [ThirdWeb Universal Bridge](/docs/thirdweb-universal-bridge)
