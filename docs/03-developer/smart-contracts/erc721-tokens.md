...
sidebar_position: 6
description: "ERC-721 is a standard for non-fungible tokens (NFTs). Unlike ERC-20 tokens, which are fungible, ERC-721 tokens are unique and distinguishable from one another."
keywords: ["erc-721", "tokens"]
tags: ["ERC721", "NFT"]
hide_table_of_contents: false
pagination_next: "developer/smart-contracts/contract-verification"
pagination_prev: "developer/smart-contracts/erc-20-tokens"
---
# ERC-721 Tokens
...
- **MetaMask** or any [EVM](/docs/07-reference/glossary#e) wallet.
