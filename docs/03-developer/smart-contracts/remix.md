...
sidebar_position: 2
description: "Remix is a powerful online integrated development environment (IDE) for developers to build, test, deploy, and manage smart contracts."
keywords: ["using", "remix"]
tags: ["remix", "IDE"]
hide_table_of_contents: false
pagination_next: "developer/smart-contracts/using-hardhat"
pagination_prev: "developer/smart-contracts/smart-contract-guidelines"
---
# Using Remix
---
...
- **Copy the contract address** from Remix and use it as the input for a search on [Core Scan](/docs/07-reference/glossary#c).
