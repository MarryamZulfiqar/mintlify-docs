...
title: "Guidelines for Smart Contract Development on Core"
sidebar_label: "Smart Contract Guidelines"
sidebar_position: 1
description: "Core blockchain is constantly evolving to provide a better user and developer experience."
keywords: ["guidelines", "for", "smart", "contract"]
tags: ["smart-contracts", "guidelines"]
hide_table_of_contents: false
pagination_next: "developer/smart-contracts/using-remix"
pagination_prev: "developer/tooling/ecosystem-contracts"
---
 ...
 * It is strongly advised to not use Core Testnet1 (chainID: 1115) since it is now decommissioned and no longer available for use.
...
* To simplify the verification process, the default EVM version for [Core Scan](/docs/07-reference/glossary#c) is set to **Shanghai** for solidity version **0.8.24^**.
