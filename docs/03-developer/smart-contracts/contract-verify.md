...
sidebar_position: 7
description: "To promote transparency, it is considered best practice to verify all deployed contracts on the Core blockchain."
keywords: ["contract", "verification"]
tags: ["contracts", "verification"]
hide_table_of_contents: false
pagination_next: "developer/dapps/build-dapp-on-core"
pagination_prev: "developer/smart-contracts/erc-721-tokens"
---
...
Create an `.env` file to store sensitive information such as your private key, [RPC](/docs/07-reference/glossary#r) URL, and API keys. This helps keep your credentials secure and allows you to reference them in your code easily.
