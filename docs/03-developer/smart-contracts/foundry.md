...
sidebar_position: 4
description: "Foundry is a fast, efficient, and extensible toolkit for EVM development written in Rust."
keywords: ["using", "foundry"]
tags: ["foundry", "tooling"]
hide_table_of_contents: false
pagination_next: "developer/smart-contracts/erc-20-tokens"
pagination_prev: "developer/smart-contracts/using-hardhat"
---
# Using Foundry
...
Foundry is a fast, efficient, and extensible toolkit for [EVM](/docs/07-reference/glossary#e) development written in Rust. This guide will walk you through the process of installing Foundry, setting up your project, writing and testing Solidity code, and deploying and verifying your contracts on Core blockchain.
...
Ensure you are using Solidity version `0.8.24`, and set the EVM version to `Shanghai`. If you're using Core Testnet (1115) note that it is now decomissioned and no longer available for use.
...
- [Using Hardhat](/docs/using-hardhat)
- [Smart Contract Guidelines](/docs/smart-contract-guidelines)
- [Contract Verification](/docs/contract-verification)
