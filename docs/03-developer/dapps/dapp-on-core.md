---
id: build-dapp-on-core
title: "Building a dApp on Core"
sidebar_label: "Build dApp on Core"
sidebar_position: 1
description: "Decentralized applications (dApps) use a blockchain or on-chain smart contracts to store and reference data, rather than relying on traditional centralized databases."
keywords: ["building", "a", "dapp", "on"]
tags: ["dapp", "development"]
hide_table_of_contents: false
pagination_next: "developer/dapps/full-stack-dapp-toolkit"
pagination_prev: "developer/smart-contracts/contract-verification"
---
# Building a dApp on Core

---

Decentralized applications (dApps) use a blockchain or on-chain smart contracts to store and reference data, rather than relying on traditional centralized databases. A common, simple dApp structure generally consists of a React.js or Vue.js front-end using Web3.js or Ethers.js to interact with smart contracts deployed to an [EVM-compatible](/docs/07-reference/glossary#e) blockchain.
