---
id: full-stack-dapp-toolkit
title: "Full-Stack Starter Kit for Building dApps on Core"
sidebar_label: "Full Stack dApp Toolkit"
sidebar_position: 2
description: "create-core-dapp is a CLI tool to bootstrap a fully functional full-stack Web3 DApp on Core."
keywords: ["full-stack", "starter", "kit", "for"]
tags: ["dapp", "scaffold"]
hide_table_of_contents: false
pagination_next: "developer/indexing/core-subgraph-overview"
pagination_prev: "developer/dapps/build-dapp-on-core"
---
...
- **Core Testnet & Mainnet** [RPC](/docs/07-reference/glossary#r) setup
- **Next.js** frontend
...
- [Build a dApp on Core](/docs/build-dapp-on-core)
- [Using Hardhat](/docs/using-hardhat)
- [Using Foundry](/docs/using-foundry)
