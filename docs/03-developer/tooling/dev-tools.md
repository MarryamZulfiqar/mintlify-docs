...
sidebar_position: 1
description: "Complete list of developer tools and resources for building on Core, including faucets, explorers, RPC endpoints, and SDKs."
keywords: ["developer", "tools", "&", "resources"]
tags: ["tools", "developer"]
hide_table_of_contents: false
pagination_next: "developer/tooling/faucet"
pagination_prev: "developer/network/add-core-network"
---
...
<TabItem value="testnet2">
  _Note: This is the latest and officially supported testnet for the Core blockchain. The previous testnet (chain ID 1115) is now decomissioned and no longer available. Developers are strongly recommended to use the new testnet "**Core Testnet2**" (chain ID 1114) to ensure continued support and access to the latest features._

- **[Block Explorer](https://scan.test2.btcs.network/):** search and review transactions, accounts, blocks, and more.

- **[RPC Endpoints](https://chainlist.org/chain/1114):** [RPC](/docs/07-reference/glossary#r) endpoints for Core Testnet's RPC service.
...
- [Core Block Explorer](/docs/block-explorer)
- [Core Faucet](/docs/faucet)
- [RPC Providers](/docs/rpc-providers)
- [Precompile Addresses](/docs/ecosystem-contracts)
