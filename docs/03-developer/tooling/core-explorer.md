---
id: block-explorer
title: "Core Scan Blockchain Explorer"
sidebar_label: "Block Explorer"
sidebar_position: 3
description: "Core Explorer is a graphic user interface designed to allow users to interact with the CORE blockchain."
keywords: ["core", "scan", "blockchain", "explorer"]
tags: ["explorer", "scan"]
hide_table_of_contents: false
pagination_next: "developer/tooling/ecosystem-contracts"
pagination_prev: "developer/tooling/faucet"
---
...
You can use the testnet [Core Scan](/docs/07-reference/glossary#c) blockchain explorer to find and review transactions. Copy your account's address from MetaMask and search for it on the explorer. In the picture below, we can see two transactions related to our account:
...
- [Developer Tools](/docs/tools-and-resources)
