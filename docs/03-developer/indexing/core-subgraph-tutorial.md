---
id: core-subgraph-tutorial
title: "Creating and Deploying a Subgraph on the Core Network"
sidebar_label: "Core Subgraph Tutorial"
sidebar_position: 2
description: "This guide outlines how to create, configure, and deploy a subgraph on the Core Network using Graph Protocol tools."
keywords: ["creating", "and", "deploying", "a"]
tags: ["subgraph", "tutorial"]
hide_table_of_contents: false
pagination_next: "developer/bridges/bridging-tokens-using-layerzero"
pagination_prev: "developer/indexing/core-subgraph-overview"
---
...
- [Core Subgraph Overview](/docs/core-subgraph-overview)
