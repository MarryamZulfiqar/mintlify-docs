---
id: core-subgraph-overview
title: "Core Subgraph using GraphQL"
sidebar_label: "Overview"
sidebar_position: 1
description: "Developers can use a self-hosted subgraph to extract data from the Core blockchain, processing and storing it for consumption via GraphQL."
keywords: ["core", "subgraph", "using", "graphql"]
tags: ["subgraph", "indexing"]
hide_table_of_contents: false
pagination_next: "developer/indexing/core-subgraph-tutorial"
pagination_prev: "developer/dapps/full-stack-dapp-toolkit"
---
...
- [Core Subgraph Tutorial](/docs/core-subgraph-tutorial)
