...
title: "Core Network Configurations"
sidebar_label: "Network Configuration"
sidebar_position: 1
description: "Core Mainnet and Testnet2 network configuration: chain IDs, RPC endpoints, and wallet setup."
keywords: ["core", "network", "configurations"]
tags: ["network", "RPC", "config"]
hide_table_of_contents: false
pagination_next: "developer/network/rpc-providers"
pagination_prev: "staking/bitcoin-hash-power-delegation"
---
...
| **Parameter**          | **Value**                              |
| ---------------------- | -------------------------------------- |
| **[RPC](/docs/07-reference/glossary#r) URL**            | https://rpc.test2.btcs.network         |
| **Chain ID**           | 1114 (0x45a)                           |
