---
id: connect-through-cli
title: "Core RPCs Through the Command Line"
sidebar_label: "Connect Through CLI"
sidebar_position: 3
description: "Blockchains generate massive amounts of data, including transaction volumes and asset ownership, which are valuable for decentralized applications (dApps) across the ecosystem."
keywords: ["core", "rpcs", "through", "the"]
tags: ["RPC", "CLI"]
hide_table_of_contents: false
pagination_next: "developer/network/connect-through-postman"
pagination_prev: "developer/network/rpc-providers"
---
...
Think of an [RPC](/docs/07-reference/glossary#r) as the reverse of an oracle. While an oracle brings external data (e.g., election results or weather forecasts) into the blockchain, an RPC extracts internal blockchain data (e.g., transaction or block information) and moves it out.
