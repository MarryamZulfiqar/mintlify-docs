---
id: connect-through-postman
title: "Connect to Core RPC Endpoints from Postman"
sidebar_label: "Connect Through Postman"
sidebar_position: 4
description: "[Postman](https://www.postman.com/) is a popular software offering that makes it easy to create and use APIs."
keywords: ["connect", "to", "core", "rpc"]
tags: ["RPC", "postman"]
hide_table_of_contents: false
pagination_next: "developer/network/add-core-network"
pagination_prev: "developer/network/connect-through-cli"
---
...
This guidebook covers the basics of hitting an [RPC](/docs/07-reference/glossary#r) endpoint with Postman. It is not intended to be (or to replace) a full, end-to-end tutorial, but rather to offer an introduction to the subject.
