...
The RelayAdapter pattern that powers Z Trade's private execution is the same pattern available to any ZApp developer who wants to integrate with the MASP. For the implementation specification, see [RelayAdapter Pattern](../developers/relayAdapter-pattern.md).
