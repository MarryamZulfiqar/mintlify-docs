---
id: archive-node
title: "Archive Nodes on Core"
sidebar_label: "Archive Node"
sidebar_position: 3
description: "Archive nodes in the Core network play a crucial role in maintaining the complete historical state of the network."
keywords: ["archive", "nodes", "on", "core"]
tags: ["config", "node"]
hide_table_of_contents: false
pagination_next: "rpc-node"
pagination_prev: "validator-node"
---
...
<Tabs
  ...
  <TabItem value="testnetTwo">
    For [Archive Node](/docs/glossary#a)s on **Core Testnet2**, following minimum hardware specifications are recommended:
...
- [RPC Node Configuration](/docs/rpc-node)
