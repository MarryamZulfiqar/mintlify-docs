---
id: snapshot-node
title: "Snapshot Nodes on Core"
sidebar_label: "Snapshot Node"
sidebar_position: 5
description: "Snapshots are essential for a network to ensure that nodes can sync up to the latest state of the network as quickly as possible."
keywords: ["snapshot", "nodes", "on", "core"]
tags: ["config", "node"]
hide_table_of_contents: false
pagination_next: "validator-overview"
pagination_prev: "rpc-node"
---
