---
id: full-node
title: "Full Nodes on Core"
sidebar_label: "Full Node"
sidebar_position: 1
description: "A Core full node  stores the entire history of the Core blockchain, enabling anyone to verify the state of any account. "
keywords: ["full", "nodes", "on", "core"]
tags: ["config", "node"]
hide_table_of_contents: false
pagination_next: "validator-node"
pagination_prev: "on-testnet"
---
...
* **[Validator](/docs/glossary#v) full node**: acts as a validator on Core, validating blocks and transactions.
* **[RPC](/docs/glossary#r) full node**: provides RPC services and responds to HTTP requests.


Following are the detailed steps to running **Normal [Full Node](/docs/glossary#f)s** on the Core network.
...
- [Run on Testnet](/docs/on-testnet)
- [Snapshot Sync](/docs/syncing-core-nodes)
- [Node Overview](/docs/types-of-nodes)
