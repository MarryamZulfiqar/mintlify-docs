---
id: on-mainnet
title: "Running Core Full Nodes on Core Mainnet"
...
keywords: ["running", "core", "full", "nodes"]
tags: ["full-node", "on-mainnet"]
hide_table_of_contents: false
pagination_next: "on-testnet"
pagination_prev: "types-of-nodes"
---
...
:::note
This document provides a detailed guideline on running Normal [Full Node](/docs/07-reference/glossary#f)s on the Core network.
:::
