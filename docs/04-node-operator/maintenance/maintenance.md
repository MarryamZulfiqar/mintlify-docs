...
sidebar_position: 1
description: "All the clients are suggested to upgrade to the latest release. The latest version is supposed to be more stable and has better performance."
keywords: ["node", "maintenance"]
tags: ["maintenance", "upgrade"]
hide_table_of_contents: false
pagination_next: "upgrading-geth"
pagination_prev: "slashing-fee"
---
# Node Maintenance
---
