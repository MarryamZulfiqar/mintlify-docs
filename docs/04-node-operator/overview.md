---
id: types-of-nodes
title: "Nodes in the Core Ecosystem"
sidebar_label: "Types of Nodes"
sidebar_position: 1
description: "In the Core ecosystem, the robustness, security, and decentralization of the network are upheld by the nodes operated by community participants."
keywords: ["nodes", "in", "the", "core"]
tags: ["nodes", "overview"]
hide_table_of_contents: false
pagination_next: "on-mainnet"
pagination_prev: "thirdweb-universal-bridge"
---
...
1. **Normal [Full Node](/docs/glossary#f)s:**
...
4. **[Archive Node](/docs/glossary#a)s:**
