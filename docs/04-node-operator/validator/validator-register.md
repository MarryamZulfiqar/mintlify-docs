---
id: register-validator-node
title: "Validator Registration"
sidebar_label: "Register Validator Node"
sidebar_position: 4
description: "How to register a validator node on Core blockchain, including on-chain registration steps and required parameters."
keywords: ["validator", "registration"]
tags: ["validator", "staking"]
hide_table_of_contents: false
pagination_next: "validator-rewards"
pagination_prev: "node-validator-election"
---
...
:::caution
Before running a [Validator](/docs/07-reference/glossary#v) node on Core, we strongly recommend reading the [Technical Whitepaper](https://whitepaper.coredao.org/).
:::
