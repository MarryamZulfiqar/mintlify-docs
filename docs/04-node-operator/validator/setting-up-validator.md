---
id: setup-validator-node
title: "Setting Up Validator Nodes on Core"
sidebar_label: "Setup Validator Node"
sidebar_position: 2
description: "This guide walks you through the process of setting up a validator node on the Core Network."
keywords: ["setting", "up", "validator", "nodes"]
tags: ["validator", "staking"]
hide_table_of_contents: false
pagination_next: "node-validator-election"
pagination_prev: "validator-overview"
---
...
<Tabs
  ...
  <TabItem value="testnet2">
    For [Validator](/docs/07-reference/glossary#v) nodes on **Core Testnet2**, following minimum hardware specifications are recommended:
...
- [Validator Node Configuration](/docs/validator-node)
